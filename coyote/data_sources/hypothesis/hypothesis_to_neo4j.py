...
def process_annotation(
    ...
    params = {
        ...
        "annotation_text_topics": annotation_text_topics_json,        # JSON str
        "highlighted_text": highlighted_text,
        "highlighted_text_topics": highlighted_text_topics_json,      # JSON str
        "annotation_text_entities": annotation_text_entities_json,    # JSON str
        "highlighted_text_entities": highlighted_text_entities_json,  # JSON str
        "tags": tags_json,                                            # list[str]
